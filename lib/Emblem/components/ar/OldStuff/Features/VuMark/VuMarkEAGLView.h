...
// UIGLViewProtocol
@interface VuMarkEAGLView : UIView <UIGLViewProtocol, SampleGLResourceHandler> {
@private
    // OpenGL ES context
    EAGLContext *context;
    ...
    UIImageView * vuMarkImage;
    NSString * currentVumarkIdOnCard;
    
    Vuforia::Matrix44F projectionMatrix;
    
    CGFloat padding;
    CGFloat textBoxWidth;
    CGFloat textBoxHeight;
    CGFloat textLabelHeight;
    
    UIView * cardView;
    CGRect cardFrameVisible;
    CGRect cardFrameHidden;
    bool cardViewVisible;
