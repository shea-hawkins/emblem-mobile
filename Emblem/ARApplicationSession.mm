...
//
//namespace {
//    ARApplicationSession* instance = nil;
...
//}
//
//@interface ARApplicationSession ()
//
...
//@end
//
//@implementation ARApplicationSession
//
//
//@synthesize viewport;
//
