...
- (void)vuforiaManagerDidFinishPreparing:(ARManager*) manager;
- (void)vuforiaManager:(ARManager*)manager didFailToPreparingWithError:(NSError*)error;
- (void)vuforiaManager:(ARManager *)manager didUpdateWithState:(VuforiaState*)state;

@end

@interface ARManager : NSObject

@property (nonatomic, weak) id<ARManagerDelegate> delegate;
...
@property (nonatomic, readonly)AREAGLView* eaglView;
